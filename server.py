...
def create_interface():
    ...
    with gr.Blocks(css=css, analytics_enabled=False, title=title, theme=ui.theme) as shared.gradio['interface']:
        ...
        if shared.is_chat():
            ...
            shared.gradio['download_button'].click(partial(chat.save_history, timestamp=True, user_request=True), gradio('history', 'mode'), gradio('download'))
...
if __name__ == "__main__":
    ...
    if shared.is_chat():
        shared.persistent_interface_state.update({
            'mode': shared.settings['mode'],
            'character': shared.args.character or shared.settings['character'],
