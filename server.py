            ...
            with gr.Box():
                ...
                with gr.Row():
                    with gr.Column():
                        ...
                        shared.gradio['eta_cutoff'] = gr.Slider(0, 0.002, value=generate_params['eta_cutoff'], step=0.0005, label='top_k', info='A hybrid of locally typical sampling and epsilon sampling. Recommended 0.0003 - 0.002, with top_p, top_k off')
                   with gr.Column():
