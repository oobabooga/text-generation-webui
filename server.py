            ...
            with gr.Box():
                with gr.Row():
                    with gr.Column():
                        ...
                        shared.gradio['exllama_info'] = gr.Markdown('To see how to set up ExLlama, check out the [README](https://github.com/turboderp/exllama#exllama) for the project on GitHub.')
