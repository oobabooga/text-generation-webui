...
def create_model_menus():
    ...
    with gr.Row():
        with gr.Column():
            shared.gradio['loader'] = gr.Dropdown(label="Model loader", choices=["Transformers", "ExLlama_HF", "ExLlama", "AutoGPTQ", "GPTQ-for-LLaMa", "llama.cpp", "llamacpp_HF", "xinference"], value=None)
            with gr.Box():
                with gr.Row():
                    with gr.Column():
                    ...
                    with gr.Column():
                        ...
                        shared.gradio['endpoint'] = gr.Textbox(label='endpoint', value=shared.args.endpoint)
