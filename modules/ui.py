...
def list_interface_input_elements(chat=False, multi_user=False):
...
def apply_interface_values(state, use_persistent=False):
    ...
    elements = list_interface_input_elements(chat=shared.is_chat(), multi_user=shared.is_multi_user())
    if len(state) == 0:
