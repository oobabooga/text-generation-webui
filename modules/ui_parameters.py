                ...
                with gr.Column():
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['temperature'] = gr.Slider(0.0, 1.99, value=generate_params['temperature'], step=0.01, label='temperature', info='temp=0 is greedy sampling (llama.cpp only)')
