                ...
                with gr.Column():
                    with gr.Row():
                        with gr.Column():
                            ...
                            with gr.Blocks():
                                shared.gradio['xtc_threshold'] = gr.Slider(0, 1, value=generate_params['xtc_threshold'], step=0.01, label='xtc_threshold', info='If there are multiple tokens with predicted probability at least xtc_threshold...')
