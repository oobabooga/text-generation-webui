                    ...
                    with gr.Box():
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                shared.gradio['max_tokens_second'] = gr.Slider(value=shared.settings['max_tokens_second'], minimum=0, maximum=15, step=1, label='Maximum number of tokens/second', info='To make text readable in real time.')
