...
loaders_and_params = OrderedDict({
    ...
    # Keep Qwen_HF the same as Transformers. Qwen does not support flash_attn2 and RoPE at this moment but keep them around
    'Qwen_HF': [
        'cpu_memory',
        'gpu_memory',
        'load_in_8bit',
...
loaders_samplers = {
    ...
    # Keep Qwen_HF the same as Transformers. TODO actually apply sampler settings to Qwen's generation
    'Qwen_HF': {
        'temperature',
        'temperature_last',
        'top_p',
