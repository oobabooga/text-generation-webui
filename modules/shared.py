...
parser.add_argument('--rope_freq_base', type=float, default=10000.0, help='Base frequency for rope sampling.')
parser.add_argument('--rope_freq_scale', type=float, default=1.0, help='Scale factor for rope sampling.')
