...
parser.add_argument('--rope-freq-scale', type=float, default=1.0, help='Size of the prompt context.')
parser.add_argument('--rope-freq-base', type=int, default=10000, help='Size of the prompt context.')
