...
group.add_argument('--model-dir', type=str, default=None, help='Path to directory with all the models.')
group.add_argument('--lora-dir', type=str, default=None, help='Path to directory with all the loras.')
group.add_argument('--model-menu', action='store_true', help='Show a model menu in the terminal when the web UI is first launched.')
group.add_argument('--settings', type=str, help='Load the default interface settings from this yaml file. If you create a file called user_data/settings.yaml, this file will be loaded by default without the need to use the --settings flag.')
...
group.add_argument('--disk-cache-dir', type=str, default=None, help='Directory to save the disk cache to.')
...
# Set defaults that depend on user_data_dir
if args.model_dir is None:
    args.model_dir = f'{args.user_data_dir}/models'
if args.lora_dir is None:
    args.lora_dir = f'{args.user_data_dir}/loras'
