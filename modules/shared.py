...
parser.add_argument('--rope-freq-scale', type=float, default=1.0, help='Scale factor for RoPE sampling.')
parser.add_argument('--rope-freq-base', type=int, default=10000, help='Base frequency for RoPE sampling.')
