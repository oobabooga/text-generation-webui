...
def create_event_handlers():
    ...
    shared.gradio['markdown_render-default'].click(lambda x: x, gradio('output_textbox'), gradio('markdown-default'), concurrency_limit=None)
    ...
    shared.gradio['Stop-default'].click(stop_everything_event, None, None, concurrency_limit=None)
