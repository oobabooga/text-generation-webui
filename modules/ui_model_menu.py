                ...
                with gr.Box():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['cache_4bit'] = gr.Checkbox(label="cache_4bit", value=shared.args.cache_4bit, info='Use Q4 cache to save VRAM. Recommended over 8-bit cache, better performance and more savings.')
