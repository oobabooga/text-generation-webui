                ...
                with gr.Box():
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['disable_exllama']=gr.Checkbox(label="disable exllama kernel", value=shared.args.disable_exllama, info='Exllama kernel requires model to be loaded on GPUs, disable if using CPU or Lora training.')
