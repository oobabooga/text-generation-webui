...
def create_event_handlers():
    ...
    shared.gradio['loader'].change(fn=lambda value: gr.update(choices=loaders.get_model_types(value)), inputs=shared.gradio['loader'], outputs=shared.gradio['model_type'])
