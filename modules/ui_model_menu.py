                ...
                with gr.Blocks():
                    ...
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['attn_implementation'] = gr.Dropdown(label="attn-implementation", choices=['eager', 'sdpa', 'flash_attention_2'], value=shared.args.attn_implementation, info='Attention implementation.')
