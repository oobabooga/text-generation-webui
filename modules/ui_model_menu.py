                ...
                with gr.Box():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['disable_exllama_info'] = gr.Markdown('* You might need to check this if you are manually setting the GPU memory on a GPTQ model. Also if you plan on Lora training it is recommended to disable exllama.')
