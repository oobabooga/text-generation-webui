                ...
                with gr.Box():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['disable_exllama_info'] = gr.Markdown('disable exllama is used for loading a GPTQ model. You might need to check this if you are manually setting the GPU memory. Also if Lora is training it is recommended to disable exllama.')
