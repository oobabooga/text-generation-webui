                ...
                with gr.Box():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['cache_q4'] = gr.Checkbox(label="cache_q4", value=shared.args.cache_q4, info='Use Q4 cache to save VRAM. Recommended over 8-bit cache, better performance and more savings.')
