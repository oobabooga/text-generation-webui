                ...
                with gr.Blocks():
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['cache_type'] = gr.Dropdown(label="cache_type", choices=['fp16', 'q8_0', 'q4_0', 'fp8', 'q8', 'q6', 'q4', 'quanto4', 'quanto2'], value=shared.args.cache_type, info='Valid options: llama.cpp - fp16, q8_0, q4_0; ExLlamaV2 - fp16, fp8, q8, q6, q4l transformers - fp16, quanto4, quanto2.')
