...
class ModelDownloader:
    ...
    def get_download_metadata_links_from_huggingface(self, model, branch, text_only=False, specific_file=None):
...
if __name__ == '__main__':
    ...
    links, sha256, is_lora, is_llamacpp = downloader.get_download_metadata_links_from_huggingface(model, branch, text_only=args.text_only, specific_file=specific_file)
