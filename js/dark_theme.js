function toggleDarkMode() {
  ...
  if (currentCSS.getAttribute("href") === "/gradio_api/file=css/highlightjs/github-dark.min.css") {
    currentCSS.setAttribute("href", "/gradio_api/file=css/highlightjs/github.min.css");
  } else {
    currentCSS.setAttribute("href", "/gradio_api/file=css/highlightjs/github-dark.min.css");
  }
