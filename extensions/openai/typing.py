...
class ChatCompletionRequestParams(BaseModel):
    ...
    instruction_template: str | None = Field(default=None, description=f"An instruction template defined under text-generation-webui/{shared.args.user_data_dir}/instruction-templates. If not set, the correct template will be automatically obtained from the model metadata.")
    ...
    character: str | None = Field(default=None, description=f"A character defined under text-generation-webui/{shared.args.user_data_dir}/characters. If not set, the default \"Assistant\" character will be used.")
