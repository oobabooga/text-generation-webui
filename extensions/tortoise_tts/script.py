...
from extensions.tortoise_tts.tortoise.tortoise import api
from extensions.tortoise_tts.tortoise.tortoise.utils.audio import load_voices
from extensions.tortoise_tts.tortoise.tortoise.utils.text import split_and_recombine_text
...
def ui():
    ...
    with gr.Accordion("Tortoise TTS"):
        ...
        preset_textbox = gr.Textbox(value=params['preset'], label='Preset')
    ...
    preset_textbox.change(lambda x: params.update({"preset": x}), preset_textbox, None)
