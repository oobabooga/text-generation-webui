...
from extensions.Silero语音朗读 import tts_preprocessor
...
def output_modifier(string):
    ...
    if string == "":
        ...
        output_file = Path(
            f"extensions/silero_tts/outputs/{shared.character}_{int(time.time())}.wav"
        )
...
def ui():
    ...
    with gr.Accordion("Silero TTS"):
        ...
        gr.Markdown(
            "[Click here for Silero audio samples](https://oobabooga.github.io/silero-samples/index.html)"
        )
    ...
    convert_confirm.click(
        ...
        None,
        convert_arr,
    ).then(remove_tts_from_history, None, None).then(
