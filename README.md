...
| `--no-fused_mlp`          | GPTQ: Disable fused mlp for triton. If you encounter "Unexpected mma -> mma layout conversion" try disabling this. May also interfere with `--gpu-memory` parameter needed for multi-gpu setups.|
