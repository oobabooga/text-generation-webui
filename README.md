...
| MacOS + MPS | Any | `pip3 install torch==2.7.1 torchvision==0.21.0 torchaudio==2.7.1` |
| Windows | NVIDIA | `pip3 install torch==2.7.1 --index-url https://download.pytorch.org/whl/cu128` |
| Windows | CPU only | `pip3 install torch==2.7.1 torchvision==0.21.0 torchaudio==2.7.1` |
